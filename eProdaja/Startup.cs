...
namespace eProdaja
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IReadService<Model.Kupac, object>, BaseReadService <Model.Kupac, Database.Kupci, object>>();
            services.AddScoped<ICovidPassService, CovidPassService>();
            services.AddScoped<IKupovineService, KupovineService>();
            services.AddScoped<IKupovineStavkeService, KupovineStavkeService>();
